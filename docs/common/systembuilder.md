...
Please get a better name for this!

## Functions

### BuildConfiguration(filename: str)

```python title="systembuilder.py" linenums="64"
...
### BuildEnergySystem(es: EnsysEnergysystem, file: str)
```python title="systembuilder.py" linenums="69"
...
### BuildKwargs(ensys_obj, oemof_es: solph.EnergySystem)
```python title="systembuilder.py" linenums="36"
...
### BuildIO(ensys_io, es)
```python title="systembuilder.py" linenums="20"
...
```python title="systembuilder.py" linenums="12"
